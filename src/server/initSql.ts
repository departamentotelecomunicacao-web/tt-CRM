// AUTO-GENERATED from prisma/sql/init.sql — não editar à mão.
// Para regenerar: npx prisma migrate diff --from-empty --to-schema-datamodel prisma/schema.prisma --script
